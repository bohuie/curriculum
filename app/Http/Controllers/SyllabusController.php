...
define("INPUT_TIPS", array(
    ...
    "missedActivityPolicy" => 'In accordance with policy on <a href="https://www.calendar.ubc.ca/okanagan/index.cfm?tree=3,41,90,1014" target="_blank" rel="noopener noreferrer">Grading Practices <i class="bi bi-box-arrow-up-right"></i></a> and <a href="https://www.calendar.ubc.ca/okanagan/index.cfm?tree=3,48,1127,0" target="_blank" rel="noopener noreferrer">Academic Concessions <i class="bi bi-box-arrow-up-right"></i></a>, state how you deal with missed in-class assessments (e.g., are make-up tests offered for missed in-class tests, do you count the best X of Y assignments/tests, do you re-weight marks from a missed test onto later assessments?)',
...
class SyllabusController extends Controller
{
    ...
    */
    ...
    public function download($syllabusId, $ext) {
        ...
        $courseNumber=$syllabus->course_num;
        ...
        $templateProcessor->setValues(array('courseTitle'=> $syllabus->course_title,'courseCode' => $syllabus->course_code, 'courseNumber'=> $courseNumber, 'courseYear'=> $syllabus->course_year, 'courseCodeCL'=> " ".($syllabus->cross_listed_code), 'courseNumberCL'=> " ".($syllabus->cross_listed_num), 'courseName'=> $courseName));
