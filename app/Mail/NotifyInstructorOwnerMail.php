...
class NotifyInstructorOwnerMail extends Mailable
{
    ...
    {
        return $this->markdown('emails.notifyInstructorOwner', [ // pass public variables (set in __construct) to notifyInstructor.blade
