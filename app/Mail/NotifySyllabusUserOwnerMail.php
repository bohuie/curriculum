...
class NotifySyllabusUserOwnerMail extends Mailable
{
    ...
    {
        return $this->markdown('emails.notifySyllabusUserOwner', [ // pass public variables (set in __construct) to notifySyllabusUser.blade
