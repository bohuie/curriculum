    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3" id="toastPlacement" style="z-index: 11">
        <div id="notification" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
            ...
            <div class="toast-body">
                You are using a password generated by the tool. You can change your password by clicking <a href="{{ route('password.request') }}">here</a>. You can also change your name by clicking <a href="{{ route('accountInformation') }}">here</a>.
            </div>
        </div>
    </div>
@endif
