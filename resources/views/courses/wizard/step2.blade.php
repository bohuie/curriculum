                                ...
                                <form id="addAssessmentMethodForm" class="needs-validation" novalidate>
                                    <div class="row align-items-end m-2">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input id="weight" type="number" step="1" class="form-control " min="0" max="100" oninput="validateMaxlength()" onpaste="validateMaxlength()" maxlength="3" required>
                                            <div class="invalid-tooltip">
                                    ...
                                    <table id="addAssessmentMethodsTbl" class="table table-light table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>                                                 
                                                    <input class="p-1" id="a_method_weight{{$a_method->a_method_id}}" type="number" step="1" form="saveAssessmentMethodChanges" class="form-control @error('weight') is-invalid @enderror" oninput="validateMaxlength()" onpaste="validateMaxlength()" maxlength="3" value="{{$a_method->weight}}" name="current_weights[{{$a_method->a_method_id}}]" min="0" max="100" required>
