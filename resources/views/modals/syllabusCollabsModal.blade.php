...
<div id="addSyllabusCollaboratorsModal{{$syllabus->id}}" class="modal fade text-start" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="addSyllabusCollaboratorsModalLabel{{$syllabus->id}}" aria-hidden="true">
        ...
        <div class="modal-content">
                    ...
                    <table id="addSyllabusCollabsTbl{{$syllabus->id}}" class="table table-light borderless" >
                        <thead>
                            <tr class="table-primary">
                                <th class="w-25">Collaborators</th>
                                <th class="w-25"></th>
                                <th colspan="2" class="text-center w-50">Actions</th>
                            </tr>
                        </thead>
            ...
            <form method="POST" id="saveSyllabusCollabChanges{{$syllabus->id}}" action="{{ action('SyllabusUserController@store', ['syllabusId' => $syllabus->id]) }}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success btn col-3" ><i class="bi bi-people-fill"></i> Save Changes</button>
                </div>
            </form>
        </div>
    </div>
